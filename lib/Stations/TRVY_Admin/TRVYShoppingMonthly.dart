...
class TRVYShoppingProviderMonthly extends ChangeNotifier {
  int selectedIndex = 0;
...
class TRVYShoppingPageMonthly extends StatefulWidget {
  const TRVYShoppingPageMonthly({super.key});

  @override
  _TRVYShoppingPageMonthlyState createState() =>
      _TRVYShoppingPageMonthlyState();
}

class _TRVYShoppingPageMonthlyState extends State<TRVYShoppingPageMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TRVYShoppingProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<TRVYShoppingProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
