...
class TRVYUtrProviderAll extends ChangeNotifier {
  int selectedIndex = 0;
...
class TRVYAdminUtrAll extends StatefulWidget {
  const TRVYAdminUtrAll({super.key});

  @override
  _TRVYAdminUtrAllState createState() => _TRVYAdminUtrAllState();
}

class _TRVYAdminUtrAllState extends State<TRVYAdminUtrAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TRVYUtrProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const TRVYAdminUtrDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
