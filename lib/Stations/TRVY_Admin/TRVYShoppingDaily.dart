...
import 'TRVY_Home.dart';

class TRVYShoppingProviderDaily extends ChangeNotifier {
  int selectedIndex = 0;
...
class TRVYShoppingPageDaily extends StatefulWidget {
  const TRVYShoppingPageDaily({super.key});

  @override
  _TRVYShoppingPageDailyState createState() => _TRVYShoppingPageDailyState();
}

class _TRVYShoppingPageDailyState extends State<TRVYShoppingPageDaily>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TRVYShoppingProviderDaily>(context);
    return Scaffold(
            ...
            child: IconButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const TRVYShoppingPageMonthly(),
                  ),
                );
              },
              icon: const Icon(
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const TRVYHomePage(),
                  ));
            },
            icon: const Icon(
              Icons.arrow_back,
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) {
                      return const TransitionPage(
                          destination: TRVYShoppingPageMonthly());
                    },
                    transitionsBuilder:
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<TRVYShoppingProviderDaily>(context, listen: false);
    return TextButton(
      onPressed: () {
