...
class TRVYShoppingProviderAll extends ChangeNotifier {
  int selectedIndex = 0;
...
class TRVYShoppingPageAll extends StatefulWidget {
  const TRVYShoppingPageAll({super.key});

  @override
  _TRVYShoppingPageAllState createState() => _TRVYShoppingPageAllState();
}

class _TRVYShoppingPageAllState extends State<TRVYShoppingPageAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TRVYShoppingProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) =>  TRVYShoppingPageDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
