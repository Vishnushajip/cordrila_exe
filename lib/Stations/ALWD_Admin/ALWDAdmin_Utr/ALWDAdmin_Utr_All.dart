...
class ALWDAdminUtrAll extends StatefulWidget {
  const ALWDAdminUtrAll({super.key});

  @override
  _ALWDAdminUtrAllState createState() => _ALWDAdminUtrAllState();
}

class _ALWDAdminUtrAllState extends State<ALWDAdminUtrAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<ALWDUtrProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const ALWDAdminUtrDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
