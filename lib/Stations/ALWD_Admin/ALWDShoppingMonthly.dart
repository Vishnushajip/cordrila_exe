...
class ALWDShoppingPageMonthly extends StatefulWidget {
  const ALWDShoppingPageMonthly({super.key});

  @override
  _ALWDShoppingPageMonthlyState createState() =>
      _ALWDShoppingPageMonthlyState();
}

class _ALWDShoppingPageMonthlyState extends State<ALWDShoppingPageMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<ALWDShoppingProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<ALWDShoppingProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
