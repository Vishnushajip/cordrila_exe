...
import 'ALWDShoppingMonthly.dart';
import 'ALWD_Home.dart';

class ALWDShoppingProviderDaily extends ChangeNotifier {
  int selectedIndex = 0;
...
class ALWDShoppingPageDaily extends StatefulWidget {
  @override
  _ALWDShoppingPageDailyState createState() => _ALWDShoppingPageDailyState();
}

class _ALWDShoppingPageDailyState extends State<ALWDShoppingPageDaily>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<ALWDShoppingProviderDaily>(context);
    return Scaffold(
            ...
            child: IconButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ALWDShoppingPageMonthly(),
                  ),
                );
              },
              icon: const Icon(
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const ALWDHomePage(),
                  ));
            },
            icon: const Icon(
              Icons.arrow_back,
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) {
                      return const TransitionPage(
                          destination: ALWDShoppingPageMonthly());
                    },
                    transitionsBuilder:
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<ALWDShoppingProviderDaily>(context, listen: false);
    return TextButton(
      onPressed: () {
