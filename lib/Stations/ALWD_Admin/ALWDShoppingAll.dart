...
class ALWDShoppingPageAll extends StatefulWidget {
  const ALWDShoppingPageAll({super.key});

  @override
  _ALWDShoppingPageAllState createState() => _ALWDShoppingPageAllState();
}

class _ALWDShoppingPageAllState extends State<ALWDShoppingPageAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<ALWDShoppingProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => ALWDShoppingPageDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
