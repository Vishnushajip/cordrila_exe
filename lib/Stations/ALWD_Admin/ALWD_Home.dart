...
import 'ALWDAdmin_Utr/ALWDAdmin_Utr_All.dart';
import 'ALWDShoppingAll.dart';

class ALWDHomePage extends StatefulWidget {
  const ALWDHomePage({super.key});

  @override
  _ALWDHomePageState createState() => _ALWDHomePageState();
}

class _ALWDHomePageState extends State<ALWDHomePage> {
  int _selectedIndex = 0;
  final int _unreadCount = 1;

  final List<Widget> _pages = [
    const ALWDShoppingPageAll(),
    ALWDAdminUtrAll(),
  ];
