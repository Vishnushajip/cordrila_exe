...
class TRVMShoppingProviderDaily extends ChangeNotifier {
  int selectedIndex = 0;
...
class TRVMShoppingPageDaily extends StatefulWidget {
  const TRVMShoppingPageDaily({super.key});

  @override
  _TRVMShoppingPageDailyState createState() => _TRVMShoppingPageDailyState();
}

class _TRVMShoppingPageDailyState extends State<TRVMShoppingPageDaily>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TRVMShoppingProviderDaily>(context);
    return Scaffold(
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) {
                      return const TransitionPage(
                          destination: TRVMShoppingPageMonthly());
                    },
                    transitionsBuilder:
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<TRVMShoppingProviderDaily>(context, listen: false);
    return TextButton(
      onPressed: () {
