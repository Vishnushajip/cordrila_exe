...
class TRVMShoppingProviderMonthly extends ChangeNotifier {
  int selectedIndex = 0;
...
class TRVMShoppingPageMonthly extends StatefulWidget {
  const TRVMShoppingPageMonthly({super.key});

  @override
  _TRVMShoppingPageMonthlyState createState() =>
      _TRVMShoppingPageMonthlyState();
}

class _TRVMShoppingPageMonthlyState extends State<TRVMShoppingPageMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TRVMShoppingProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<TRVMShoppingProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
