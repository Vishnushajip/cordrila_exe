...
import 'TRVMAdmin_Utr_daily.dart';

class TRVMUtrProviderAll extends ChangeNotifier {
  int selectedIndex = 0;
...
class TRVMAdminUtrAll extends StatefulWidget {
  const TRVMAdminUtrAll({super.key});

  @override
  _TRVMAdminUtrAllState createState() => _TRVMAdminUtrAllState();
}

class _TRVMAdminUtrAllState extends State<TRVMAdminUtrAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TRVMUtrProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const TRVMAdminUtrDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
