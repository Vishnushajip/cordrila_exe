...
class TRVMUtrProviderMonthly extends ChangeNotifier {
  int selectedIndex = 0;
...
class TRVMAdminUtrMonthly extends StatefulWidget {
  const TRVMAdminUtrMonthly({super.key});

  @override
  _TRVMAdminUtrMonthlyState createState() => _TRVMAdminUtrMonthlyState();
}

class _TRVMAdminUtrMonthlyState extends State<TRVMAdminUtrMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TRVMUtrProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<TRVMUtrProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
