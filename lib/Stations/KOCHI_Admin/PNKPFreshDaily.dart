...
class PNKPShoppingPageDaily extends StatefulWidget {
  const PNKPShoppingPageDaily({super.key});

  @override
  _PNKPShoppingPageDailyState createState() => _PNKPShoppingPageDailyState();
}

class _PNKPShoppingPageDailyState extends State<PNKPShoppingPageDaily>
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const PNKPHomePage(),
                  ));
            },
            icon: const Icon(
              Icons.arrow_back,
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<PNKPShoppingProviderDaily>(context, listen: false);
    return TextButton(
      onPressed: () {
