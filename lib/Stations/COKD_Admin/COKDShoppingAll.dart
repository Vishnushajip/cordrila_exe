...
class COKDShoppingProviderAll extends ChangeNotifier {
  int selectedIndex = 0;
...
class COKDShoppingPageAll extends StatefulWidget {
  const COKDShoppingPageAll({super.key});

  @override
  _COKDShoppingPageAllState createState() => _COKDShoppingPageAllState();
}

class _COKDShoppingPageAllState extends State<COKDShoppingPageAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<COKDShoppingProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const COKDShoppingPageDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
