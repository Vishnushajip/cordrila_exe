...
class COKDShoppingProviderMonthly extends ChangeNotifier {
  int selectedIndex = 0;
...
class COKDShoppingPageMonthly extends StatefulWidget {
  const COKDShoppingPageMonthly({super.key});

  @override
  _COKDShoppingPageMonthlyState createState() =>
      _COKDShoppingPageMonthlyState();
}

class _COKDShoppingPageMonthlyState extends State<COKDShoppingPageMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<COKDShoppingProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<COKDShoppingProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
