...
class COKDUtrProviderMonthly extends ChangeNotifier {
  int selectedIndex = 0;
...
class COKDAdminUtrMonthly extends StatefulWidget {
  const COKDAdminUtrMonthly({super.key});

  @override
  _COKDAdminUtrMonthlyState createState() => _COKDAdminUtrMonthlyState();
}

class _COKDAdminUtrMonthlyState extends State<COKDAdminUtrMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<COKDUtrProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<COKDUtrProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
