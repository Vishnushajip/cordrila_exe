...
import 'COKDAdmin_Utr_daily.dart';

class COKDUtrProviderAll extends ChangeNotifier {
  int selectedIndex = 0;
...
class COKDAdminUtrAll extends StatefulWidget {
  const COKDAdminUtrAll({super.key});

  @override
  _COKDAdminUtrAllState createState() => _COKDAdminUtrAllState();
}

class _COKDAdminUtrAllState extends State<COKDAdminUtrAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<COKDUtrProviderAll>(context);
    return Scaffold(
        ...
        bottom: PreferredSize(
          ...
          child: Row(
            ...
            children: [
              ...
              Tooltip(
                exitDuration: const Duration(milliseconds: 1),
                message: "Utr Daily Data",
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const COKDAdminUtrDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
