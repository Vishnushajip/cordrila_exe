...
class PNTVShoppingProviderMonthly extends ChangeNotifier {
  int selectedIndex = 0;
...
class PNTVShoppingPageMonthly extends StatefulWidget {
  const PNTVShoppingPageMonthly({super.key});

  @override
  _PNTVShoppingPageMonthlyState createState() =>
      _PNTVShoppingPageMonthlyState();
}

class _PNTVShoppingPageMonthlyState extends State<PNTVShoppingPageMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<PNTVShoppingProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<PNTVShoppingProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
