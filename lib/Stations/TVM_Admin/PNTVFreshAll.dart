...
class PNTVShoppingPageAll extends StatefulWidget {
  const PNTVShoppingPageAll({super.key});

  @override
  _PNTVShoppingPageAllState createState() => _PNTVShoppingPageAllState();
}

class _PNTVShoppingPageAllState extends State<PNTVShoppingPageAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<PNTVShoppingProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const PNTVShoppingPageDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
