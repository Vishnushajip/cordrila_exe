...
class PNTVShoppingProviderDaily extends ChangeNotifier {
  int selectedIndex = 0;
...
class PNTVShoppingPageDaily extends StatefulWidget {
  const PNTVShoppingPageDaily({super.key});

  @override
  _PNTVShoppingPageDailyState createState() => _PNTVShoppingPageDailyState();
}

class _PNTVShoppingPageDailyState extends State<PNTVShoppingPageDaily>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<PNTVShoppingProviderDaily>(context);
    return Scaffold(
            ...
            child: IconButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const PNTVShoppingPageMonthly(),
                  ),
                );
              },
              icon: const Icon(
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const PNTVHomePage(),
                  ));
            },
            icon: const Icon(
              Icons.arrow_back,
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) {
                      return const TransitionPage(
                          destination: PNTVShoppingPageMonthly());
                    },
                    transitionsBuilder:
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<PNTVShoppingProviderDaily>(context, listen: false);
    return TextButton(
      onPressed: () {
