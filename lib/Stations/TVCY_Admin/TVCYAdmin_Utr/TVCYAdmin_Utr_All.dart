...
class TVCYUtrProviderAll extends ChangeNotifier {
  int selectedIndex = 0;
...
class TVCYAdminUtrAll extends StatefulWidget {
  const TVCYAdminUtrAll({super.key});

  @override
  _TVCYAdminUtrAllState createState() => _TVCYAdminUtrAllState();
}

class _TVCYAdminUtrAllState extends State<TVCYAdminUtrAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TVCYUtrProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const TVCYAdminUtrDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
