...
class TVCYUtrProviderMonthly extends ChangeNotifier {
  int selectedIndex = 0;
...
class TVCYAdminUtrMonthly extends StatefulWidget {
  const TVCYAdminUtrMonthly({super.key});

  @override
  _TVCYAdminUtrMonthlyState createState() => _TVCYAdminUtrMonthlyState();
}

class _TVCYAdminUtrMonthlyState extends State<TVCYAdminUtrMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TVCYUtrProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<TVCYUtrProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
