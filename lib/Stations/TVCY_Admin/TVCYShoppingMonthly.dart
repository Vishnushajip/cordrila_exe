...
class TVCYShoppingProviderMonthly extends ChangeNotifier {
  int selectedIndex = 0;
...
class TVCYShoppingPageMonthly extends StatefulWidget {
  const TVCYShoppingPageMonthly({super.key});

  @override
  _TVCYShoppingPageMonthlyState createState() =>
      _TVCYShoppingPageMonthlyState();
}

class _TVCYShoppingPageMonthlyState extends State<TVCYShoppingPageMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TVCYShoppingProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<TVCYShoppingProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
