...
import 'TVCYShoppingDaily.dart';
import 'TVCYShoppingMonthly.dart';

class TVCYShoppingProviderAll extends ChangeNotifier {
  int selectedIndex = 0;
...
class TVCYShoppingPageAll extends StatefulWidget {
  const TVCYShoppingPageAll({super.key});

  @override
  _TVCYShoppingPageAllState createState() => _TVCYShoppingPageAllState();
}

class _TVCYShoppingPageAllState extends State<TVCYShoppingPageAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<TVCYShoppingProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => TVCYShoppingPageDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
