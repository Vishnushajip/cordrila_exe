...
class AdminFreshMonthly extends StatefulWidget {
  const AdminFreshMonthly({super.key});

  @override
  _AdminFreshMonthlyState createState() => _AdminFreshMonthlyState();
}

class _AdminFreshMonthlyState extends State<AdminFreshMonthly>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<FreshFilterProviderMonthly>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<FreshFilterProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
  ...
  Future<void> _downloadMonthlyData(
    ...
    try {
      ...
      await _downloadCSV(
          context, rows, 'Fresh_monthly_data_$formattedDateTime');
    } catch (e) {
