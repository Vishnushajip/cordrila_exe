...
class ShoppingPageMonthly extends StatefulWidget {
  const ShoppingPageMonthly({super.key});

  @override
  _ShoppingPageMonthlyState createState() => _ShoppingPageMonthlyState();
}

class _ShoppingPageMonthlyState extends State<ShoppingPageMonthly>
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<ShoppingProviderMonthly>(context, listen: false);
    return TextButton(
      onPressed: () {
