...
import 'Admin_shopping_daily.dart';
import 'Admin_shopping_monthly.dart';

class ShoppingProviderAll extends ChangeNotifier {
  int selectedIndex = 0;
...
class ShoppingPageAll extends StatefulWidget {
  const ShoppingPageAll({super.key});

  @override
  _ShoppingPageAllState createState() => _ShoppingPageAllState();
}

class _ShoppingPageAllState extends State<ShoppingPageAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<ShoppingProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const ShoppingPageDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        CupertinoPageRoute(
                          builder: (context) => const ShoppingPageMonthly(),
                        ),
                      );
                    },
                    child: const Text(
