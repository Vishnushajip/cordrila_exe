...
class ShoppingPageDaily extends StatefulWidget {
  const ShoppingPageDaily({super.key});

  @override
  _ShoppingPageDailyState createState() => _ShoppingPageDailyState();
}

class _ShoppingPageDailyState extends State<ShoppingPageDaily>
                  ...
                  PageRouteBuilder(
                    pageBuilder: (context, animation, secondaryAnimation) {
                      return const TransitionPage(
                          destination: ShoppingPageMonthly());
                    },
                    transitionsBuilder:
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<ShoppingProviderDaily>(context, listen: false);
    return TextButton(
      onPressed: () {
