...
class FreshFilterPage extends StatefulWidget {
  const FreshFilterPage({super.key});

  @override
  _FreshFilterPageState createState() => _FreshFilterPageState();
}

class _FreshFilterPageState extends State<FreshFilterPage>
  ...
  Future<void> _downloadMonthlyData(
    ...
    try {
      ...
      await _downloadCSV(context, rows, 'Fresh_monthly_data$formattedMonth');
    } catch (e) {
