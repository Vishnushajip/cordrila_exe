...
class AdminUtrAll extends StatefulWidget {
  const AdminUtrAll({super.key});

  @override
  _AdminUtrAllState createState() => _AdminUtrAllState();
}

class _AdminUtrAllState extends State<AdminUtrAll>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<UtrProviderAll>(context);
    return Scaffold(
                ...
                child: TextButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          CupertinoPageRoute(
                            builder: (context) => const AdminUtrDaily(),
                          ));
                    },
                    child: const Text(
                      "Daily",
