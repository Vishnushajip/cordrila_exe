...
class UtrProviderDaily extends ChangeNotifier {
  int selectedIndex = 0;
...
class AdminUtrDaily extends StatefulWidget {
  const AdminUtrDaily({super.key});

  @override
  _AdminUtrDailyState createState() => _AdminUtrDailyState();
}

class _AdminUtrDailyState extends State<AdminUtrDaily>
  ...
  Widget build(BuildContext context) {
    final filterProvider = Provider.of<UtrProviderDaily>(context);
    return Scaffold(
  ...
  Widget _buildTabButton(BuildContext context, int index, String text) {
    final filterProvider =
        Provider.of<UtrProviderDaily>(context, listen: false);
    return TextButton(
      onPressed: () {
